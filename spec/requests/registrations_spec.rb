...
RSpec.describe "Questions", type: :request do
  ...
  let(:invaild_user_params) { attributes_for(:user, name: "") }
  ...
  describe "POST /resource" do
    ...
    context "ログインをしていない場合" do
      ...
      context "無効な属性の場合" do
        it "ユーザーが登録されないこと" do
          expect { post user_registration_path, params: { user: invaild_user_params } }.not_to change(User, :count)
        end
        it "エラーが表示されること" do
          post user_registration_path, params: { user: invaild_user_params }
